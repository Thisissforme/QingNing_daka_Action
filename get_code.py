...
def TestFunc():
    pd_id = "128237"  # 用户中心页可以查询到pd信息
    pd_key = "hKWIEzPletx5TrTMmvV+5fX48y4GMXZc"
    app_id = "328237"  # 开发者分成用的账号，在开发者中心可以查询到
    app_key = "BC3e3kQrt+ceTlYKEANV0hvcP+oTTB+a"
    #识别类型，
